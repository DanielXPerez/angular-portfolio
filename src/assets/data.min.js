...
const data = {
	...
	Home: {
		introduction: "Accomplished Senior Software Engineer with expertise in Python3, Java, Rust, and a strong focus on performance optimization, codebase refactoring, and feature implementation. Skilled in delivering maintainable, scalable solutions in distributed remote environments.",
		resumeLink: "resume.pdf",
		typedElement: ["Daniel Perez", "Python3", "Java", "Rust", "Go", "TypeScript", "C++", "Distributed Systems", "CI/CD", "Cloud Computing"]
	},
	About: {
		...identity,
		NavTabs: [{
		...
		about: {
			"tech-stats": "Senior Software Engineer, Performance Optimization, Distributed Systems And AI Systems Enthusiast",
			bio: "Accomplished Senior Software Engineer with expertise in Python3, Java, Rust, and a strong focus on performance optimization, codebase refactoring, and feature implementation. Demonstrated ability to drive collaboration in cross-functional teams and enhance AI systems with precise, real-world coding expertise. Skilled in delivering maintainable, scalable solutions in distributed remote environments.",
			"IDE, Editors & Tools": ["VS Code", "Intellij", "PyCharm", "CLion", "Docker", "Git", "CI/CD tools", "Cloud computing platforms"]
		},
		skills: [
			[{
				skill: "Python3",
			...
			[{
				...
				skill: "System Architecture Evaluation",
				progress: "85"
			}, {
				skill: "CI/CD Tools",
				progress: "85"
	...
	Training: {
		...
		training: [
			[{
				...
				description: "Developed scalable solutions for hybrid IT systems using C++, Python, and cloud-based tools. Contributed to feature development for data storage and enterprise AI solutions, improving product adaptability for client-specific needs.",
				link: "https://www.hpe.com/"
			}, {
				class: "Right",
				title: "GitHub",
				subtitle: "Senior Software Engineer",
				date: "May, 2017 - May, 2026",
				description: "Led the design and development of high-performance features for a global source code hosting platform, integrating Python3, Java, and Rust. Executed codebase refactoring and performance optimization, optimized CI/CD automation pipelines with Go and TypeScript, and mentored junior engineers in collaborative remote environments.",
	...
	},
	{
		...
		links: [{
			type: "mailto:",
			title: "danielxperez9119@outlook.com"
		}]
	}],
	Social: [
		[{
		...
		{
			link: "https://linkedin.com/in/danielperez4527",
