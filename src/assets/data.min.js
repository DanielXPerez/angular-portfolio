...
const data = {
	...
	Home: {
		introduction: "Full Stack Developer with proven experience at Applify, GoldenHippo and SperidianTechnologiesin helping companies create and maintain a better code base for reusability.",
		resumeLink: "resume.pdf",
		typedElement: ["Christoffer Ali", "React", "Angular", "Vue.js", "Node.js", "Machine Learning", "Php/Laravel", "Flutter", "Python/Flask", "Django", "C/C++", "ASP.NET", "Blockchain(Solidity)", "NFT marketplace" ,"Spring Boot Developer", "DevOps"]
	},
	About: {
		...identity,
		NavTabs: [{
	...
	Portfolio: {
		"react" : [{
			...
			delay: "0.5s",
			project: "OutfitAI",
			description: "React+Express+Python+Tensorflow",
			png: "1.png",
			...
			description: "WEB3+Next.js+Tailwind.css+Rust",
			png: "2.png",
			url: "https://async.art",
			placement: "top"
		}, {
			...
			animationClass: "rotateInUpLeft",
			delay: "0.5s",
			project: "Online retailer",
			description: "Shopify+StripeAPI",
			url: "https://perpetualkid.com",
			png: "10.png",
			placement: "bottom"
		}, {
			animationClass: "slideInUp",
			...
			delay: "0.5s",
			project: "FACEHUB",
			description: "Vue.js+Django+PyTorch",
			png: "13.png",
	...
	Contact: [{
		...
		links: [{
			type: "tel:",
			title: "+1 832 699 0288"
		}, {
			type: "tel:",
			title: "+1 786 347 1994"
		}]
	}, {
		animationClass: "Right",
		title: "E-Mail",
		...
		links: [{
			type: "mailto:",
			title: "natural.spirit.0102@gmail.com"
		}]
	}],
	Social: [
		[{
		...
		//  {
		// 	link: "https://www.linkedin.com/in/dnle102/",
